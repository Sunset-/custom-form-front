(function () {
    ...
    var SunsetWebsocket = {
        ...
        connect(options) {
            ...
            if (!this.connectionMap[topic]) {
                ...
                this._connect(ctx);
                return this.promiseHolder[topic] = new Promise(function (resolve, reject) {
                    SunsetWebsocket.promiseMap[topic] = {
                        resolve,
                        reject,
                        isNew: true
                    };
        ...
        trigger: function (topic, eventName) {
            var pubsub;
    ...
    window.SunsetWebsocket = SunsetWebsocket;
