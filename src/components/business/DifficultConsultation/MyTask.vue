    ...
    export default {
                                ...
                                res.forEach(item=>{
                                    item.forEach(value=>{
                                        if(value.partyaCategory==Sunset.Service.Dictionary.alias('ORG_CODE','HOSPITAL')){
                                            if(value.scenesType & Sunset.Service.Dictionary.alias('SCENES_CATEGORY','difficultyflow')){
                                                hospitalList[value.partyaMemberId]=value.partya.name;
                                            }
                                        }
                                    });
                                });
        ...
        methods: {
            getOrganizeList(){
                ...
                this.myTask[list.office.id]=list.office.name;
            ...
            chooseBody(item){
                if(item.name=="咨询列表"){
                    ...
                    // Router.go(`${this.$route.path}/MyTask`);
                }
            },
            leftFilter(f) {
            ...
            checkFlow(data){
                ...
                Router.go(`/DifficultConsultation/MyTask/${data[0]}/${data[1]}`);
            },
            finishClinic(flowId) {
