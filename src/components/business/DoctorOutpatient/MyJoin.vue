            ...
            return {
                ...
                options: {
                    ...
                    columns:[{
                            ...
                            title:"业务类型",
                            name:"special.flow.type",
                            format:(v)=>{
                               return Sunset.Service.Dictionary.transcode('SCENES_CATEGORY',Sunset.Service.Dictionary.alias('SCENES_CATEGORY',v));
                            }
                        },{
                            title:"流程状态",
                            name:"special.flow",
                            format:(v)=>{
                                if(v.detailStatus){
                                    return v.detailStatus?Sunset.Service.Dictionary.transcode('REFERRAL_FLOW_STATUS',v.detailStatus):''
                                }else{
                                    return v.status?Sunset.Service.Dictionary.transcode('FLOW_STATUS',v.status):''
                                }
                            }
                        },{
                            title:"目标机构/专家",
                            name:"special.flow.currentTarget",
                            format:(v)=>{
                                return v.name
                            }
                        },{
