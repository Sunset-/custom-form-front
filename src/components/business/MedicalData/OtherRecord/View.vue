...
<template>
    <div class="video-card-view">
        <h3>其他记录 <span> ({{card.lastModifyDate | time 'yyyy/MM/dd HH:mm'}}  {{card.creator.name}}编辑) </span></h3>
...
<script>
    export default {
        ...
        computed: {
            ...
            DIAGNOSIS(){
                return Sunset.Service.Dictionary.transcode('OTHER_RECORD_TYPE',this.data.type)
            }
        }
    }
</script>