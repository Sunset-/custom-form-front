    ...
    <div class="check_order_info">
        <div v-if="actived=='转出'"  class="flow_info">
            <div class="patient">
                ...
                <p class="mian_info" style="font-size:16px;"><span>初步诊断：{{diagnose}}</span><span>检查项目：{{checkNo}}</span></p>
        ...
        <div v-if="actived=='转入'" class="flow_info">
            ...
            <div class="operate" v-if="safeData.flow.detailStatus!=7 && safeData.flow.detailStatus!=6 && safeData.flow.detailStatus!=3 && !safeData.flow.hasPassiveClosed">
    ...
    export default {
        ...
        computed:{
            ...
            checkNo(){
               ...
               return checkType?checkType.split(",").length:this.safeData.flow.extension&&JSON.parse(this.safeData.flow.extension).cardInfo.length;
            },
            isMedicalCenter(){
            ...
            patientAge(){
                return this.safeData.registration&&this.safeData.registration.patientAge.replace(',','')
            },
            registeredDept(){
