...
(function () {
    ...
    FLEXPAPER.initLoginForm = function initLoginForm(IMGFiles, animate) {
        ...
        jQuery(img).bind('load', function () {
            ...
            jQuery('.flexpaper_htmldialog').css({
                height: '0px',
                display: 'block'
            });
            jQuery('.flexpaper_htmldialog').animate({
                'height': theight + 'px',
                'top': '0px'
            }, {
                ...
                complete: function () {
                    ...
                    jQuery('.flexpaper_publication').animate({
                        opacity: 1
                    }, {
...
(function () {
    ...
    var f = extend(window.flashembed, {
        ...
        isSupported: function (ver) {
            return true; //VERSION[0] > ver[0] || VERSION[0] == ver[0] && VERSION[1] >= ver[1];
        }
